...
const stepDescriptions = {
  0: [ // 안드로이드 버전 확인
    ...
    "4. 소프트웨어 정보를 선택합니다.",
    "5. 안드로이드 버전을 확인합니다. <span style='color: #dc3545; font-weight: bold;'>안드로이드 버전이 6.0.1 버전이 아닐 경우</span>, 담당 선생님 혹은 밀크T 고객센터로 연락 부탁드립니다."
  ],
  1: [ // 런처 설치 (21개)
    "1. 화면 오른쪽 아래의 앱스를 터치합니다.",
    "2. 오른쪽 위의 검색을 터치합니다.",
...
const additionalNotes = {
  1: { // 런처 설치
    ...
    20: "밀크T와 함께해주셔서 감사합니다. 만약 설치 진행이 어려우시거나 정상적으로 설치가 되지 않는 경우에는, <span style='color: #dc3545; font-weight: bold;'> 담당 선생님 혹은 밀크T 고객센터로 연락 부탁드립니다.</span>"
  }
};
