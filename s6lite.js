...
const stepDescriptions = {
  0: [ // 안드로이드 버전 확인
    ...
    "4. 소프트웨어 정보를 선택합니다.",
    "5. 안드로이드 버전을 확인합니다. <span style='color: #dc3545; font-weight: bold;'>안드로이드 버전이 10 버전이 아닐 경우</span>, 담당 선생님이나 밀크T 고객센터로 연락 부탁드립니다."
  ],
  1: [ // 런처 설치 (20개)
    "1. 화면을 아래에서 위로 끌어올려 앱 목록 화면으로 이동합니다.",
    "2. 오른쪽 위의 돋보기를 터치합니다.",
...
const additionalNotes = {
  1: { // 런처 설치
    ...
    19: "밀크T와 함께해주셔서 감사합니다. 만약 설치 진행이 어려우시거나 정상적으로 설치가 되지 않는 경우에는, <span style='color: #dc3545; font-weight: bold;'>담당 선생님이나 밀크T 고객센터로 연락 부탁드립니다.</span>"
  }
};
